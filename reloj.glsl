...
vec3 drawScene(vec2 uv) {
  ...
  float segment1 = sdSegment(uv, vec2(0.0, .0), vec2(sin(iTime*.3)*0.2, cos(iTime*.3)*0.2));    //hour
  float segment2 = sdSegment(uv, vec2(0.0, .0), vec2(sin(iTime*3.6)*0.4, cos(iTime*3.6)*0.4));  //minute
